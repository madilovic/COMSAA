...
for file in os.listdir('input'):
    if file.endswith('.clustal'):
        ...
        MSA_mutations = MSA_df[MSA_df["alignment"]==' '].transpose().iloc[:-1]
        ...
        for i in CDS_start.index:
            CDS_combined = CDS_combined.union(set(range(CDS_start[i],CDS_stop[i]+1)))
            
        CDS_combined_df = MSA_df[MSA_df.iloc[:,0].isin(CDS_combined)]
        nonCDS_combined_df = MSA_df[MSA_df.iloc[:,0].isin(CDS_combined) == False]
        
        CDS_combined_df_mutations = CDS_combined_df[CDS_combined_df["alignment"]==' '].iloc[:,:-1]
        nonCDS_combined_df_mutations = nonCDS_combined_df[nonCDS_combined_df["alignment"]==' '].iloc[:,:-1]
        ...
        for name1 in names:
            ...
            for name2 in names:
                ...
                try:
                    nonCDS_tt_ratio.at[name1, name2] = transitions/transversions
                except:
        ...
        for i in range(len(names)-1):
            summary_pairwise.at[names[i+1],'Similarity'] = MSA_similarity.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'Mutations'] = MSA_mutation_num.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'Mutation_Freq'] = summary_pairwise.at[names[i+1],'Mutations']/total_length
            summary_pairwise.at[names[i+1],'Transitions'] = MSA_transition_num.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'Transversions'] = MSA_transversion_num.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'TT_ratio'] = MSA_tt_ratio.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'Gaps'] = MSA_gaps.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'Insertions'] = MSA_insertions.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'Deletions'] = MSA_deletions.loc[names[i+1],names[i]]
            
            summary_pairwise.at[names[i+1],'CDS_Similarity'] = CDS_similarity.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'CDS_Mutations'] = CDS_mutation_num.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'CDS_Mutation_Freq'] = summary_pairwise.at[names[i+1],'CDS_Mutations']/CDS_length
            summary_pairwise.at[names[i+1],'CDS_Transitions'] = CDS_transition_num.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'CDS_Transversions'] = CDS_transversion_num.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'CDS_TT_ratio'] = CDS_tt_ratio.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'CDS_Gaps'] = CDS_gaps.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'CDS_Insertions'] = CDS_insertions.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'CDS_Deletions'] = CDS_deletions.loc[names[i+1],names[i]]
            
            summary_pairwise.at[names[i+1],'nonCDS_Similarity'] = nonCDS_similarity.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'nonCDS_Mutations'] = nonCDS_mutation_num.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'nonCDS_Mutation_Freq'] = summary_pairwise.at[names[i+1],'nonCDS_Mutations']/nonCDS_length
            summary_pairwise.at[names[i+1],'nonCDS_Transitions'] = nonCDS_transition_num.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'nonCDS_Transversions'] = nonCDS_transversion_num.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'nonCDS_TT_ratio'] = nonCDS_tt_ratio.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'nonCDS_Gaps'] = nonCDS_gaps.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'nonCDS_Insertions'] = nonCDS_insertions.loc[names[i+1],names[i]]
            summary_pairwise.at[names[i+1],'nonCDS_Deletions'] = nonCDS_deletions.loc[names[i+1],names[i]]
